...
The project includes an interactive prototype and presentation dashboard for demonstrating the autonomous arXiv research pipeline. The prototype presents the stateful RAG architecture, live pipeline execution, grounded QA behavior, and automated test results.

### 🖥️ Prototype 1: System Overview & Telemetry Snapshot

The overview screen presents the **7-stage stateful graph**, Pydantic `AgentState`, local RRF hybrid search, supported LLM providers, test status, and graceful degradation mode.

![Prototype System Overview](doc/prototype/prototype_overview.png)

### ⚙️ Prototype 2: Live Pipeline Demo & Executive Briefing

The live demo shows the complete execution flow: query understanding, arXiv retrieval, paper selection, PDF acquisition, section-aware parsing, vector indexing, and generation of the executive briefing artifact.

![Prototype Live Pipeline Demo](doc/prototype/prototype_pipeline_demo.png)

### 🧪 Prototype 3: Automated Test Suite

The prototype includes a visual test-suite demonstration showing **30 / 30 tests passed** with a 100% pass rate across the implemented test coverage.

![Prototype Test Suite](doc/prototype/prototype_test_suite.png)

### 🔎 Prototype Highlights

- **7-stage Stateful Graph** for explicit agent orchestration.
- **Live Pipeline Telemetry** showing each processing stage.
- **Grounded Executive Briefing** with explicit limitations.
- **RRF Hybrid Retrieval** using local vector and lexical search.
- **Grounded QA Guardrails** for unsupported questions.
- **30 automated tests** with the demonstrated 30 / 30 pass result.
